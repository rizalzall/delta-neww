...
category: 'user',
async: async (m, { func, mecha, froms, setting, listblock }) => {
...
let { name, gender, age, limit, balance, premium, banned, warning, register, date, pasangan, expired, level, exp, role } = global.db.users[froms]
